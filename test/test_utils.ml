...
let test_digits () =
  ...
  check (list int) "digits of 1001" [ 1; 0; 0; 1 ]
    (Utils.digits 1001)
...
let test_is_palindrome () =
  ...
  check bool "12321 is palindrome" true
    (Utils.is_palindrome 12321);
  check bool "123 is not palindrome" false
    (Utils.is_palindrome 123);
  check bool "10 is not palindrome" false
    (Utils.is_palindrome 10)
